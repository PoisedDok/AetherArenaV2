# Contributing to AetherArena

Thank you for your interest in contributing to AetherArena! This guide will help you set up your development environment and understand our development workflow.
...
Host Machine
  ↓
Docker Compose (aether-arena-dev)
...
- Check existing [Issues](https://github.com/bytedance/aether-arena/issues)
- Read the [Documentation](backend/docs/)
- Ask questions in [Discussions](https://github.com/bytedance/aether-arena/discussions)

## License

By contributing to AetherArena, you agree that your contributions will be licensed under the [MIT License](./LICENSE).
