...
{
  "graphs": {
    "lead_agent": "aether.agents:lead_agent"
  },
...
```python
from aether.config.title_config import TitleConfig, set_title_config
...
# 测试 title 生成
import pytest
from aether.agents.title_middleware import TitleMiddleware
...
- [`packages/harness/aether-arena/agents/thread_state.py`](../packages/harness/aether-arena/agents/thread_state.py) - ThreadState 定义
- [`packages/harness/aether-arena/agents/title_middleware.py`](../packages/harness/aether-arena/agents/title_middleware.py) - TitleMiddleware 实现
- [`packages/harness/aether-arena/config/title_config.py`](../packages/harness/aether-arena/config/title_config.py) - 配置管理
- [`config.yaml`](../config.yaml) - 配置文件
- [`packages/harness/aether-arena/agents/lead_agent/agent.py`](../packages/harness/aether-arena/agents/lead_agent/agent.py) - Middleware 注册
