...
This document provides a comprehensive overview of the AetherArena backend architecture.
...
|-------------|---------------|
| `/mnt/user-data/workspace` | `backend/.aether-arena/threads/{thread_id}/user-data/workspace` |
| `/mnt/user-data/uploads` | `backend/.aether-arena/threads/{thread_id}/user-data/uploads` |
| `/mnt/user-data/outputs` | `backend/.aether-arena/threads/{thread_id}/user-data/outputs` |
| `/mnt/skills` | `aether-arena/skills/` |
...
2. Gateway receives file
   - Validates file
   - Stores in .aether-arena/threads/{thread_id}/user-data/uploads/
...
3. Returns response
   {
     "files": [{
       "filename": "doc.pdf",
       "path": ".aether-arena/.../uploads/doc.pdf",
