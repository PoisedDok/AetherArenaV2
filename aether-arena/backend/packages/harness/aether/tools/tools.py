...
from aether.tools.builtins import present_file_tool, render_html_tool, render_ui_tool, task_tool, view_image_tool
...
def get_available_tools(
    ...
    `initialize_mcp_tools()` from aether.mcp module.
    ...
    if include_mcp:
        try:
            ...
            from aether.mcp.cache import get_cached_mcp_tools
            ...
            if extensions_config.get_enabled_mcp_servers():
                ...
                if mcp_tools:
                    ...
                    if config.tool_search.enabled:
                        from aether.tools.builtins.tool_search import DeferredToolRegistry, set_deferred_registry
                        from aether.tools.builtins.tool_search import tool_search as tool_search_tool
