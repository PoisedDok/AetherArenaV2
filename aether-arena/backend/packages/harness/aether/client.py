...
from aether.agents.lead_agent.agent import _build_middlewares
from aether.agents.lead_agent.prompt import apply_prompt_template
from aether.agents.thread_state import ThreadState
from aether.config.agents_config import AGENT_NAME_PATTERN
from aether.config.app_config import get_app_config, reload_app_config
from aether.config.model_config import model_to_gateway_dict
from aether.config.extensions_config import ExtensionsConfig, SkillStateConfig, get_extensions_config, reload_extensions_config
...
class DeerFlowClient:
    ...
    def _ensure_agent(self, config: RunnableConfig):
        ...
        if checkpointer is None:
            from aether.agents.checkpointer import get_checkpointer
    ...
    def list_models(self) -> dict:
        ...
        """
        return {
            "models": [model_to_gateway_dict(m) for m in self._app_config.models],
        }
    ...
    def list_skills(self, enabled_only: bool = False) -> dict:
        ...
        """
        from aether.skills.loader import load_skills
    ...
    def get_model(self, name: str) -> dict | None:
        ...
        if model is None:
            return None
        return model_to_gateway_dict(model)
    ...
    def install_skill(self, skill_path: str | Path) -> dict:
        ...
        """
        from aether.skills.loader import get_skills_root_path
        from aether.skills.validation import _validate_skill_frontmatter
    ...
    def reload_memory(self) -> dict:
        ...
        """
        from aether.agents.memory.updater import reload_memory_data
    ...
    def get_memory_config(self) -> dict:
        ...
        Returns:
            Memory config dict.
        """
        from aether.config.memory_config import get_memory_config
    ...
    def upload_files(self, thread_id: str, files: list[str | Path]) -> dict:
        ...
        """
        from aether.utils.file_conversion import CONVERTIBLE_EXTENSIONS, convert_file_to_markdown
