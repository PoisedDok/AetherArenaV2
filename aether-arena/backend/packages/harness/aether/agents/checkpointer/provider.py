...
Usage::
    ...
    from aether.agents.checkpointer.provider import get_checkpointer, checkpointer_context
...
from aether.config.checkpointer_config import CheckpointerConfig
from aether.config.paths import resolve_path
...
def get_checkpointer() -> Checkpointer:
    ...
    from aether.config.app_config import _app_config
    from aether.config.checkpointer_config import get_checkpointer_config
