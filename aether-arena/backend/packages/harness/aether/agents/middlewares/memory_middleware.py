...
from aether.agents.memory.queue import get_memory_queue
...
class MemoryMiddleware(AgentMiddleware[MemoryMiddlewareState]):
    ...
    def after_agent(self, state: MemoryMiddlewareState, runtime: Runtime) -> dict | None:
        ...
        # Client preference: skip queuing memory updates (absent or non-false = enabled)
        if runtime.context.get("auto_memory") is False:
            return None
