...
from aether.agents.memory.prompt import format_conversation_for_update
from aether.agents.memory.updater import MemoryUpdater, _extract_text
...
def test_apply_updates_skips_same_batch_duplicates_and_keeps_source_metadata() -> None:
    ...
    update_data = {
        "newFacts": [
            ...
            {"content": "User works on AetherArena", "category": "context", "confidence": 0.87},
        ],
    }
