...
class TestInfoQuestClient:
    ...
    @patch("aether.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("aether.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("aether.community.infoquest.tools.get_app_config")
...
class TestImageSearch:
    ...
    # In /Users/bytedance/python/aether-arenav2/aether-arena/backend/tests/test_infoquest_client.py
