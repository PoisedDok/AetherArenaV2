...
See: https://github.com/bytedance/aether-arena/issues/1149
"""
...
class TestSerializeToolMessageContent:
    """AetherArenaClient._serialize_message should normalize ToolMessage content."""

    def test_string_content(self):
        msg = ToolMessage(content="ok", tool_call_id="tc1", name="search")
        result = AetherArenaClient._serialize_message(msg)
...
class TestExtractText:
    """AetherArenaClient._extract_text should handle all content shapes."""
    ...
    def test_fallback_non_iterable(self):
        assert AetherArenaClient._extract_text(123) == "123"
