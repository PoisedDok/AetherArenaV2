...
from aether.tools.builtins.tool_search import (
...
class TestToolSearchTool:
    def test_no_registry(self):
        from aether.tools.builtins.tool_search import tool_search
...
class TestDeferredToolsPromptSection:
    ...
    def _mock_app_config(self, monkeypatch):
        ...
        from aether.config.tool_search_config import ToolSearchConfig
