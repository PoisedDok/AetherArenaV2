...
from aether.agents.memory.updater import _save_memory_to_file, get_memory_data, reload_memory_data
from aether.config.memory_config import get_memory_config, set_memory_config
...
async def get_memory() -> MemoryResponse:
    ...
    Example Response:
        ```json
        {
            ...
            "user": {
                "workContext": {"summary": "Working on AetherArena project", "updatedAt": "..."},
...
async def get_memory_config_endpoint() -> MemoryConfigResponse:
    ...
    Example Response:
        ...
        {
            "enabled": true,
            "storage_path": ".aether-arena/memory.json",
            "debounce_seconds": 30,
            "max_facts": 100,
