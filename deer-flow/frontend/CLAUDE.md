...
AetherArena v2 frontend is a Next.js 16 web interface for the agent system. It communicates with a LangGraph-based backend to provide thread-based AI conversations with streaming responses, artifacts, and a skills/tools system.
...
- **`core/`** — Business logic, the heart of the app:
  ...
  - `i18n/` — Internationalization (English-only, `en-US`)
