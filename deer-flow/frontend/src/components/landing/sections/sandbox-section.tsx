...
export function SandboxSection({ className }: { className?: string }) {
  return (
    <Section
      ...
      subtitle={
        <p>
          The assistant can use an isolated runtime to run commands, manage
          files, and carry out longer jobs safely.
        </p>
      }
    >
      <div className="mt-8 flex w-full max-w-6xl flex-col items-center gap-12 lg:flex-row lg:gap-16">
        ...
        <div className="w-full flex-1 space-y-6">
          ...
          <div className="space-y-4 text-lg text-zinc-400">
            <p>
              When enabled, tasks run in an isolated environment with browser,
              shell, and file access so everyday work stays separated from your
              main system.
            </p>
          </div>
