...
type SettingsDialogProps = React.ComponentProps<typeof Dialog> & {
  defaultSection?: SettingsDialogSectionId;
};
...
export function SettingsDialog(props: SettingsDialogProps) {
  ...
  const [activeSection, setActiveSection] =
    useState<SettingsDialogSectionId>(defaultSection);
  ...
  return (
    ...
    >
      <DialogContent
        className="flex h-[75vh] max-h-[calc(100vh-2rem)] flex-col sm:max-w-5xl md:max-w-6xl text-foreground"
                ...
                return (
                  <li key={id}>
                    <button
                      type="button"
                      onClick={() =>
                        setActiveSection(id as SettingsDialogSectionId)
                      }
                      className={cn(
