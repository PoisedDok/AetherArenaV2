...
def test_put_compact_config_updates_field():
    ...
    from deerflow.config.compact_config import get_compact_config, set_compact_config, CompactConfig
...
def test_put_compact_config_token_threshold():
    ...
    from deerflow.config.compact_config import set_compact_config, CompactConfig
    set_compact_config(CompactConfig())
...
def test_put_compact_config_doc_summarization_ratio():
    ...
    from deerflow.config.compact_config import set_compact_config, CompactConfig
    from deerflow.config.doc_summarization_config import set_doc_summarization_config, DocSummarizationConfig
    set_compact_config(CompactConfig())
